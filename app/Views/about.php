        ...
        <div class="col">
            <div class="card mb-3">
                <div class="row no-gutters">
                    <div class="col">
                        <div class="card-body">
                            <h4><span class="font-weight-bold">W</span>eather<span class="font-weight-bold">MX</span> About</h4>
                            <p>WeatherMX - an elegant, free, open-source web application built to display data form CumulusMX; the USB weather stations data logger.</p>
                            <br><br>
